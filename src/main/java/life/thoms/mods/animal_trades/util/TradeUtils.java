...
public class TradeUtils {
    ...
    public static List<String> getAvailableTrade(Player player, Entity animal, InteractionHand hand) {
        ...
        for (List<String> innerListOriginal : tradesList) {
            ...
            Holder<MobEffect> playerEffect = ForgeRegistries.MOB_EFFECTS
                    .getHolder(new ResourceLocation(innerList.get(3))).orElse(null);
            ...
            if (existingEffect != null) {
                ...
                if (effectDuration > maxEffectDuration) {
                    sendSoundAndParticles(player, animal, SoundEvents.NOTE_BLOCK_BASS.get(), ParticleTypes.CLOUD);
                    continue;
                }
